...
async function addFeatures (req, res) {
    try {
        ...
        features.energy.sort(function(a,b){return a-b})
        features.instrument.sort(function(a,b){return a-b})
        features.danceability.sort(function(a,b){return a-b})
        features.acousticness.sort(function(a,b){return a-b})
        features.valence.sort(function(a,b){return a-b})
